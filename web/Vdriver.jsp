<%-- 
    Document   : Vdriver
    Created on : 12 Mar, 2023, 12:01:46 PM
    Author     : niran
--%>
...
<body style="background-image:url(Image/background3.jpg);background-size:cover;opacity:99%;">  
 <form action="Vdriver.jsp" method="POST">
     <div class="divbtn" style="hight:30px;background:silver;">
          <div class="row">
              ...
              <div class="col-sm-3">
                  ...
                  <a style="margin-left:100px;" href="ViewRegisterD.jsp" >All Customer Details...</a>
              </div>
          </div>
      </div>
  <div class="container">
 ...
 <div class="div1">
        <form action="ViewDriver" method="post">
              <img src="Image/driver.jpg" name="cimg" height="200" width="250"><br>
