<%-- 
    Document   : Vbookingd
    Created on : 13 Mar, 2023, 6:03:49 PM
    Author     : niran
--%>
    ...
    <body style="background-image:url(Image/background3.jpg);background-size:cover;opacity:99%;">
      ...
      <!--<div class="divbtn" style="hight:30px;background:silver;">
          <div class="row">
              ...
              <div class="col-sm-3">
                  ...
                  <a style="margin-left:100px;" href="ViewBookingD.jsp" >All Customer Details...</a>
              </div>
          </div>
      </div>-->
        <div class="container">
     <%
       ...
       Statement st=null;
        ...
        String sql="select * from booking where duser='"+session.getAttribute("driver_name")+"'";
    ...
    %>
     <div class="div1">
        <form action="ViewBooking" method="post">
             ...
             <label><%=mno%></label>
             <input type="hidden" name="des" value="<%=mno%>"><br><br>
